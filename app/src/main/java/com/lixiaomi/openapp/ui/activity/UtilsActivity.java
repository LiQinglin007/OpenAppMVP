...
public class UtilsActivity extends BaseActivity implements View.OnClickListener {
    ...
    private android.support.v7.widget.AppCompatTextView mMineChoosetime;
    private android.support.v7.widget.SwitchCompat mMineChoosetimeSw;
    private android.support.v7.widget.AppCompatTextView mMineChooseTimeMin;
    private android.support.v7.widget.AppCompatTextView mMineChooseTimeDidi;
    private android.support.v7.widget.AppCompatTextView mMineChoosesex;
    private android.support.v7.widget.AppCompatTextView mMineBottomList;
    private android.support.v7.widget.AppCompatTextView mMineBottomUserlist;
    private android.support.v7.widget.AppCompatTextView mMineSingOut;
    private android.support.v7.widget.SwitchCompat mMineSingOutSw;
    private android.support.v7.widget.AppCompatTextView mMineDownload;
